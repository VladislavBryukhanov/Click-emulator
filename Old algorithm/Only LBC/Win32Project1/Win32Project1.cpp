...
BOOL CALLBACK DlgProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_TIMER:
		...
		if(btn[maxI]==0)
		{
			mouse_event(MOUSEEVENTF_LEFTDOWN,0, 0, 0, 0);//игнорирует заданные координаты(х и у) даже если вместо них поставить константные числа
			mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
		}
		else if(btn[maxI]==1)
		{
			mouse_event(MOUSEEVENTF_RIGHTDOWN,0, 0, 0, 0);//игнорирует заданные координаты(х и у) даже если вместо них поставить константные числа
